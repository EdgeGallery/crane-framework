 ...
 * @LastEditTime: 2020-07-16 12:20:22
 */ 
#include "MepServiceRegister.h"

namespace NS_CRANE {
    const std::string MepServiceRegister::serviceRegisterBody = "{\
    \"serName\": \"###\",    \
    \"serCategory\": {  \
    ...
    void MepServiceRegister::doInteraction() {
        ...
        for (auto s : _services) {
            Document d;
            d.Parse(serviceRegisterBody.c_str());
            ...
            builder.append(U("/mep/mec_service_mgmt/v1/applications/" + s + "/services"));
